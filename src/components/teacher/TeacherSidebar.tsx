...
import { LayoutDashboard, CalendarCheck2, BookOpenText } from "lucide-react";
import { cn } from "@/lib/utils";
import { LogoutButton } from "@/components/shared/LogoutButton";

const NAV_ITEMS = [
  { href: "/teacher", label: "أفواجي", icon: LayoutDashboard },
  { href: "/teacher/attendance", label: "تسجيل الحضور", icon: CalendarCheck2 },
] as const;
      ...
      <div>
        <div className="mb-8 flex items-center gap-2.5 px-2 pt-2">
          ...
          <div>
            ...
            <p className="text-xs text-white/60">لوحة المعلم</p>
          </div>
        </div>
